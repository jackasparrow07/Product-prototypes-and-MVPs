...
Improve the above code and then allow saving the whole things as  a .md, .docx, .csv and .xlsx fliles separately and toeghter in one shot.


I undersand that the insights are basic output, but I am looking for a insights converted into simple English langauge insights, as to what it all means , how to make sense of it and how to make further inferences on these. Even the most complex visual should have easy to understand explained insights.
